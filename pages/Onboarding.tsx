...
function Onboarding() {
  ...
  return (
    <div className='font-sans px-10 max-w-full. items-center w-screen '>
      ...
      {
        currentStep === 4 && ( <RegisterNamePage  setCurrentStep={setCurrentStep} currentStep={currentStep}/> ) 
      }
      {
        currentStep === 5 && ( <ConfirmUsername setCurrentStep={setCurrentStep}  currentStep={currentStep} /> ) 
      }
      {
