...
export const Nav = (props:any) => {
    ...
    // bg-base-100
    return (
        <div className={`w-screen fixed top-0 border-b-2 border-base-100/50 z-30 font-inter flex justify-between sm:h-[76px] 
        h-[66px] px-6 items-center ${isDark ? ('bg-[#131A2E]'):('bg-[#FEFEFF] ')} overflow-visible md:px-16 items-center sm:px-10 backdrop-blur-md brightness-80`}>
