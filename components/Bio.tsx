...
export const Bio = (props: Props) => {
    ...
    return (
        <div className={props.className}>
            <div className="max-h-fit w-full mx-auto text-sviolet font-extrabold pt-1 p-6 my-auto">
                <div className="my-auto">
                    <h1 className="text-sviolet text-left font-extrabold text-lg mt-6">Bio </h1>
