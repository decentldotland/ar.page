...
function OverviewSteps() {
  ...
  return (
    <section>
        <div onClick={() => setToggle(!toggle)} className='mb-2 px-3 bg-[#edecec] py-2 rounded-xl items-center mt-4 w-[210px]'>
            <div className='flex flex-row justify-between items-center'>
            <h1 className='text-[#6a6b6a] text-left text-lg'>Here's an overview</h1>
            {toggle ? (
