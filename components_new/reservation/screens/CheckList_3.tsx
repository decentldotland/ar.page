    ...
    <>
        <section className='relative h-screen  '>
                  ...
                  <div className='items-center '>
                    ...
                    <h1 className='text-3xl font-bold mb-2'>You're so close! Time to <br/>claim your ArPage.</h1>
                    <p className='text-left text-[#8e8e8f] text-sm'>
                      You're almost there! Your ArPage is ready to be minted.
                    </p>
                    <OverviewSteps />
