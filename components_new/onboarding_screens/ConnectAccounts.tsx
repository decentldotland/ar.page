...
function ConnectAccounts(props: ConnectAccountsInterface) {
  ...
  return (
    <div className='md:relative md:top-32 relative h-screen flex flex-col w-full sm:w-[440px] px-5'>
        ...
        <div onClick={() => props.addressNear ? props.handleOnboarding(2) : props.connect()} className={btnDynamicStyling}>
            <div className='flex items-center space-x-2.5'>
                ...
                <h3 className='text-sm font-semibold text-left '>
                    {props.addressNear ? "Near Wallet Connected. Click to Proceed." : "Near"}
                </h3>
            </div>
        ...
        <button onClick={() => props.connect()}>Test</button>
