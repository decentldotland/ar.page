  ...
  const [toggle, setToggle] = useState(false);
    ...
    return (
      <section ref={container}>
              ...
              displayImg !== undefined ? (
                  <div className='relative mt-1 items-center'>
                    <Image 
                      ...
                      src={displayImg} />
                    <div className='rounded-full shadow-lg absolute bottom-6 left-4
                  ...
                  <div className='rounded-full bg-gradient-to-l from-[#9E00FF] to-[#1273EA]  h-[38px] w-[38px]'>
                    ...
                    <div className={`rounded-full  drop-shadow-2xl  relative left-4 bottom-1 items-center flex justify-center
                         ${backgroundColour ? backgroundColour : 'bg-[#CECECF]'}
                      h-6 w-6 border-[#edecec] border-2`}>
                      <Image src={chainIconUrl!} height={16} width={16} />
                    </div>
                </div>
              )
        ...
        {
          toggle && (
            <div className='py-2 mt-3 px-5 h-[124px] w-[346px] bg-[#edecec] rounded-xl shadow-xl absolute z-50'>
